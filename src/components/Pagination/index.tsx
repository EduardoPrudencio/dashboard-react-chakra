...
export function Pagination({totalCountRegisters, registerPerPage =10, currentPage = 1, onPageChange }: PaginationProps){
    ...
    return (
        ...
        >
            ...
            {previousPages.length > 0 && previousPages.map(p => {
                return <PaginationItem onPageChange={onPageChange} key={p} number={p} />
            })}

            <PaginationItem onPageChange={onPageChange} isCurrent={true} number={currentPage} />

            {nextPages.length > 0 && nextPages.map(p => {
                return <PaginationItem onPageChange={onPageChange} key={p} number={p} />
            })}    
